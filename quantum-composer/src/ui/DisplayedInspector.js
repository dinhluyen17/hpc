...
class DisplayedInspector {
     ...
     */
    paint(painter, stats, dragPainter, simPainter) {
    ...
    */
     ...
     * @returns {!number}
     */
    // Phu: function to get height of canvas area
    desiredHeight() {
        let minimumDesired =
            //this.displayedToolboxBottom.desiredHeight() +
            //this.displayedToolboxTop.desiredHeight() +
            this.displayedCircuit.desiredHeight() + 150;
