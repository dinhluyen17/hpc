...
public enum Status {
    ...
    CIRCUIT_ALREADY_EXISTS(10205, "circuit {0} already exists", "项目名称[{0}]已存在"),
    CREATE_CIRCUIT_ERROR(10206, "create circuit error", "创建项目错误"),
    CIRCUIT_NOT_EXIST(10207, "circuit {0} not exists", "用户[{0}]不存在"),
    UPDATE_CIRCUIT_ERROR(10208, "update circuit error", "更新用户错误"),
    DELETE_CIRCUIT_ERROR(10209, "delete circuit error", "删除资源错误"),
    GET_CIRCUIT_INFO_ERROR(10210, "get circuit info error", "获取用户信息错误"),
    QUERY_CIRCUIT_LIST_PAGING_ERROR(10211, "query user list paging error", "分页查询用户列表错误"),
    DUPLICATE_CIRCUIT_ERROR(10212, "duplicate circuit error", "获取用户信息错误"),
    EXPORT_CIRCUIT_ERROR(10213, "export circuit error", "获取用户信息错误"),
    BATCH_EXPORT_CIRCUIT_ERROR(10214, "batch export circuit error", "获取用户信息错误"),
